  ...
  return (
    <div className="home-container">
      ...
      <section className="hero">
        ...
        <div className="hero-text">
          ...
          <div className="hero-buttons">
            <button className="home-getstart-btn" onClick={handleGetStarted}>Get Started →</button>
            <button className="home-exploreproduct-btn" onClick={handleExploreProducts}>Explore Products</button>
          </div>
      ...
      <section className="features">
        ...
        <p className="section-subtitle">We connect farmers directly to buyers, revolutionizing the agricultural market.</p>
      ...
      <section className="how-it-works">
        ...
        <button className="btn btn-primary" onClick={handleExploreProducts}>View All Products →</button>
      </section>
